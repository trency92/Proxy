...
public class IntranetService_RelayTest extends BaseTest {
    ...
    private void trans(Socket entry) throws Throwable {
        ...
        Thread entrySender1 = new Thread("entrySender1") {
            @SneakyThrows
            public void run() {
        ...
        Thread entrySender2 = new Thread("entrySender2") {
            @SneakyThrows
            public void run() {
                for (int i = 0; i < count; i++) {
                    byte[] data = rand();
        ...
        entryReceiveLengths1 = new LinkedList<>();
        entryReceiveLengths2 = new LinkedList<>();
        entryReceiveData1 = entryReceiveData2 = EMPTY_BYTE_ARRAY;
        Thread entryReceiver = new Thread("entryReceiver") {
            @SneakyThrows
            public void run() {
