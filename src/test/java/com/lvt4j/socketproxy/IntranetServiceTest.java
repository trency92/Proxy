...
public class IntranetServiceTest extends BaseTest {
    ...
    public void trans() throws Throwable {
        ...
        Thread client1Sender = new Thread("client1Sender") {
            @SneakyThrows
            public void run() {
        ...
        Thread client2Sender = new Thread("client2Sender") {
            @SneakyThrows
            public void run() {
        ...
        client1Sender.start();
        target1 = targetServer.accept();
        client2Sender.start();
        target2 = targetServer.accept();

        assertCnns(2, 2);

        target1Receives = target2Receives = EMPTY_BYTE_ARRAY;
        Thread target1Receiver = new Thread("target1Receiver") {
            @SneakyThrows
            public void run() {
        ...
        Thread target2Receiver = new Thread("target2Receiver") {
            @SneakyThrows
            public void run() {
        ...
        target1Receiver.start();
        target2Receiver.start();
        ...
        Thread target1Sender = new Thread("target1Sender") {
            @SneakyThrows
            public void run() {
        ...
        Thread target2Sender = new Thread("target2Sender") {
            @SneakyThrows
            public void run() {
        ...
        Thread client1Receiver = new Thread("client1Receiver") {
            @SneakyThrows
            public void run() {
        ...
        Thread client2Receiver = new Thread("client2Receiver") {
            @SneakyThrows
            public void run() {
        ...
        client2Receiver.start();

        long wait = count * 20;
        client1Sender.join(wait);
        client2Sender.join(wait);
        target1Receiver.join(wait);
        target2Receiver.join(wait);
        target1Sender.join(wait);
        target2Receiver.join(wait);
        client1Receiver.join(wait);
        client2Receiver.join(wait);

        assertFalse(client1Sender.isAlive());
        assertFalse(client2Sender.isAlive());
        assertFalse(target1Receiver.isAlive());
        assertFalse(target2Receiver.isAlive());
        assertFalse(target1Sender.isAlive());
        assertFalse(target2Receiver.isAlive());
        assertFalse(client1Receiver.isAlive());
        assertFalse(client2Receiver.isAlive());
